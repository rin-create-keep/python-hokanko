# コマンドライン ToDo 管理ツール
概要
このプログラムは、仕事や勉強、買い物など日々のタスクをターミナル上で素早く管理できます。
視認性を高めるため色分けや期限表示を工夫し、紙のメモ以上の使いやすさを目指しました。
「毎日の小さな達成感を可視化したい」という思いで作成されています。
...
# 実行方法
このプログラムは ターミナル（またはコマンドプロンプト） で実行します。

保存先のフォルダに移動して、以下のコマンドで起動します：
python todo_list7.py
